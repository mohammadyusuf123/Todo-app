...
import {updatedTodo} from '../../redux/Todo/thunk/updatedTodo.js'
import {updatedColor} from '../../redux/Todo/thunk/updatedColor.js'
import {deleteTodo} from '../../redux/Todo/thunk/deleteTodo.js'

const Todo = ({singleTodo}) => {
    const {id,text,completed,color}=singleTodo
    const dispatch=useDispatch()
    const handleStatusChange=(todoId)=>{
        dispatch( updatedTodo(todoId,completed))
    }
